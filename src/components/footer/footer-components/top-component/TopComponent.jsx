  ...
  return (
    <div className={styles['footer-top-outer-container']}>
        <div className={styles['kenaz-container']}>
            ...
            <p className={styles['kenaz-text-par']}>Lorem ipsum dolor sit amet, consectetur adipsiscing elit. Vivamus leo ante.</p>
        ...
        <div className={styles['newsletter-container']}>
            <h2>Newsletter</h2>
            <p>Lorem ipsum dolor sit amet, consectetur adidpsicing elit. Vivamus leo ante...</p>
